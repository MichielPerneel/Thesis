...
eels <- as.tibble(read.csv2("C:/Users/user/Desktop/Biologie/Master/Thesis/Thesis/data/raw/data_inbo_glasaal_gekuist.csv", sep = ";", header = TRUE, dec = ","))
...
plot(eels$Condition_factor~eels$K)
